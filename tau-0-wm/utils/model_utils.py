...
def forward_pass(
    ...
    **kwargs,
    ...
    # Restored from commit 1a99742 (was removed in dfb1559 while runner/posttrain.py
    # still imports it). This is a legacy inference helper and is NOT called by the
    # posttrain.py training loop (which invokes self.diffusion_model(...) directly).
