...
def get_optimizer(
    ...
    if optimizer_name == "adamw":
        ...
        # MAINLINE-R4 environment-compatibility fix (post-reboot driver 580.173.02 /
        # CUDA 13.0): the vectorized AdamW "foreach" path is a known intermittent
        # "CUDA error: misaligned address" source on H100 bf16 (see V4-B). Disable
        # it. This does NOT change the training recipe (lr/betas/eps/wd unchanged).
        if optimizer_class is torch.optim.AdamW:
            init_kwargs["foreach"] = False
